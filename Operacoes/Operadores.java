...
public class Operadores { // Classe

    public void aritmetica() { // Metódo
        System.out.println("===============================");
        int adicao = 5 + 2;
    ...
    public void atribuicao() {
        System.out.println("===============================");
        int umNumero = 5;// Atribuição de uma variavel inteira
        umNumero += 2;// Mesma coisa que (umNumero= umNumero+2;)
    ...
    public void relacionais() {
        ...
        int primeiraVariavel = 3456725;
        int segundaVariavel = 4375674;
