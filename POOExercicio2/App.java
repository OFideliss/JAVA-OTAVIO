...
public class App {
    ...
    public static void main(String[] args) {
        ...
        // System.out.println(JOptionPane.showInputDialog("Nome que deseja os dados:
        // "));
        // criando variavel e armazenando o nome digitado
        String procuraNome = JOptionPane.showInputDialog("Nome que deseja buscar:");
        int contadorPosicao = 0;

        while (!procuraNome.equals(pessoas[contadorPosicao].getNome())) { // enquanto o nome desejado for difente do nome do
